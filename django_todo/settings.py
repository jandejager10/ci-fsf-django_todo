...
SECRET_KEY = 'django-insecure-84a$dqns9lpi)0=f*wr#q*lhzqdqff6sol9t4^qb1$znp-=o+r'
...
DATABASES = {
    'default':dj_database_url.parse(os.environ.get('postgres://u6wftz21rdn:qrDHMfUE5XAb@ep-gentle-mountain-a23bxz6h-pooler.eu-central-1.aws.neon.tech/mom_cheek_image_251078'))
}
